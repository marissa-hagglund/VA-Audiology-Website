...
@Component({
  ...
  template: `
    ...
    <screener-question *ngIf="currentState === 3" [question]="questionStrings.question3" [radio1]="'Always'" [radio2]="'Usually'" [radio3]="'Sometimes/Occasionally'"
                       (onClickedBack)="moveStateBackward()" (onClickedNext)="moveStateForward($event)"></screener-question>
    <screener-question *ngIf="currentState === 4" [question]="questionStrings.question4" [radio1]="'YES, Always'" [radio2]="'YES, Sometimes'" [radio3]="'NO'"
                       (onClickedBack)="moveStateBackward()" (onClickedNext)="moveStateForward($event)"></screener-question>
    ...
    <screener-question *ngIf="currentState === 6" [question]="questionStrings.question6" [radio1]="'Daily or weekly basis'" [radio2]="'Monthly or yearly basis'"
                       (onClickedBack)="moveStateBackward()" (onClickedNext)="moveStateForward($event)"></screener-question>
  `
})
